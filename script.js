  ...
  return `
    <div class="soil-card">
      <header class="soil-card-header">
        <div class="soil-card-header-content">
          <div class="soil-card-title">
            ...
            <h2>Independent interpretation of soil test data — not an official government SHC</h2>
          </div>
        </div>
      </header>
      ...
      <section class="soil-card-section">
        <h4>Disclaimer</h4>
        <div class="recommendation-box">
          <p>This report is generated by the Department of Soil & Water Conservation, Nagaland for research and training. It is NOT the legally recognised Government of India Soil Health Card. For the official and legally valid SHC, please visit <a href="https://soilhealth.dac.gov.in" target="_blank" rel="noopener">soilhealth.dac.gov.in</a>. Use this report only as advisory information and only after obtaining farmer consent to process their data.</p>
        </div>
      </section>
