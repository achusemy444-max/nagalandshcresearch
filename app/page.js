              ...
              <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr' }}>
                <div className="hero-copy">
                  ...
                  <div className="hero-contact">
                    ...
                    <p><strong>Note:</strong> This is a research and training service run by the Department of Soil & Water Conservation, Nagaland. For disclaimer check support and contact us section</p>
                  </div>
                </div>
              </div>
            </section>
